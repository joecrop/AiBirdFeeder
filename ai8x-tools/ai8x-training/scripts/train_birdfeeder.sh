...
cp $OLDEST_LOG/best.pth.tar ../ai8x-synthesis/trained/ai85-birdfeeder.pth.tar
cp $OLDEST_LOG/qat_best.pth.tar ../ai8x-synthesis/trained/ai85-birdfeeder_qat.pth.tar